...
import {readObservation, editObservation} from "../utils/api";
...
function ObservationEdit() {
  ...
  useEffect(() => {
    async function loadObservation() {
        try {
          const observationFromAPI = await readObservation(observationId);
            if (observationFromAPI) setObservation(observationFromAPI);  
        } catch (errorFromAPI) {
